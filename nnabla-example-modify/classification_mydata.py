...
import nnabla.utils.data_iterator as d		# [modify] 独自のCSVを読み込むライブラリをインポート
...
def train():
    ...
    * Training loop
    ...
    # [modify] CSVを読み込むように変更
    data = d.data_iterator_csv_dataset('./train.csv', args.batch_size, True, rng=RandomState(1223))
    vdata = d.data_iterator_csv_dataset('./test.csv', args.batch_size, False)
    
    # [add] 読み込んだデータの形状などを確認
    #image_data, label_data = data.next()
    #vimage_data, vlabel_data = vdata.next()
    #print(image_data.shape)
    #print(label_data.shape)
    #print(vimage_data.shape)
    #print(vlabel_data.shape)
    ...
    for i in range(start_point, args.max_iter):
        if i % args.val_interval == 0:
            ...
            for j in range(args.val_iter):
                ...
                vimage.d = vimage.d * 255.0         # [modify] 0～1.0 を 0～255に変換
        ...
        image.d = image.d * 255.0         # [modify] 0～1.0 を 0～255に変換
        solver.zero_grad()
